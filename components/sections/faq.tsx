...
function AccordionItem({
  ...
  return (
    <div className="border-b border-border">
      ...
      {isOpen && (
        <div className="pb-3.5 text-[0.85rem] leading-snug text-muted-foreground sm:pb-5 sm:text-base sm:leading-relaxed">
          {answer}
        </div>
      )}
    </div>
...
export function FAQ() {
  ...
  return (
    <section id="faq" className="bg-background px-5 py-14 sm:px-8 sm:py-20 lg:py-28">
      <div className="mx-auto max-w-[1200px]">
        ...
        >
          ...
          <RevealItem className="mt-2 text-[0.85rem] leading-snug text-muted-foreground sm:mt-4 sm:text-base sm:leading-relaxed">
            <p>
